 ...
 */
exports.testRoomID = function(host, callback) {
...
exports.addRoomToDB = function(host, hostIP, callback) {
...
exports.deleteRoomFromDB = function(host, hostIP, callback) {
    var params = {
        Key: {
            RoomHost: { S: host }
        },
...
exports.publish = function(numRooms){
    var params = {
    	Message: 'A new room has been created. The number of current rooms is ' + numRooms, /* required */
    	TopicArn: 'arn:aws:sns:us-east-1:191927237267:Node_js_project'
  	};
